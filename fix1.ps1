...
# Save as run_fix.bat and run it
...
[System.IO.File]::WriteAllText("C:\Users\Kleiner\proyectos\mi_app\lib\main.dart", $content, [System.Text.Encoding]::UTF8)
Write-Host "main.dart fixed!"