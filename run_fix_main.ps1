...
$path = "C:\Users\Kleiner\proyectos\mi_app\lib\main.dart"
[System.IO.File]::WriteAllText($path, $mainDart, [System.Text.Encoding]::UTF8)
Write-Host "main.dart written successfully"