...
void main() {
  ...
  group('HourTvStartupCover & CatalogRepository Race Condition Tests', () {
    testWidgets('1. Primera instalación con BD vacía y sincronización retardada: cover no se oculta antes de tiempo', (tester) async {
    ...
    testWidgets('2. Instalaciones posteriores con caché local válida: entra de inmediato en offlineReady', (tester) async {
    ...
    testWidgets('3. Fallo en primera instalación: muestra pantalla de error con botón Reintentar y recupera', (tester) async {
